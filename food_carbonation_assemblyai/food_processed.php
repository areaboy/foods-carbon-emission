...
$image_url_ok = str_replace(' ', '', $image_url);
...
<div>
<img class='img-rounded' src='$image_url'style='width:400px;max-width:400px;height:400px;max-height:400px;border-style: solid; border-width:3px; border-color: navy;'>
</div>
...
<div style='width:100%;' class='col-sm-12'></div><br>";
 ...
 echo "<br><br><div class='title_css1'><b style='color:navy;font-size:26px;'>Foods Nutrients Breakdown & it's Carbon Emission Data</b><br>";
